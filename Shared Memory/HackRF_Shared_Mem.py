...
def FM_demod(sample_rate,Decimation,Data_Condition,Fm_Condition,Samps):
    ...
    while True:
        with Data_Condition:
            ...
            RawData=RawData[0]+RawData[1]*1j
...
def FM_Audio(sample_rate,Decimation,Mode,Fm_Condition,Data_len):
    ...
    while True:
        ...
        with Fm_Condition:
            ...
            numpy.copyto(Stereo,FMData)
            numpy.copyto(Mono,FMData)
...
if __name__ == '__main__':
    ...
    Fm=Process(target=FM_demod, args=(sample_rate,Fm_decimation,RX_Data_ready,FM_Data_Ready,Base_Samples))
    Audio=Process(target=FM_Audio, args=(sample_rate/(Fm_decimation),Audio_decimation,"Mono",FM_Data_Ready,Fm_Size))
