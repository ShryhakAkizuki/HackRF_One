...
def Graph_Pyqtgraph_Core(Title_1,x_1,y_1,x_2,y_2,freq):
...
if __name__ == '__main__':
    ...
    Graph=Process(target=Graph_Pyqtgraph_Core, args=("FFT",FFT_FM_Axis_Graph_Buffer_Global,FFT_FM_Graph_Buffer_Global,FFT_Data_Axis_Graph_Buffer_Global,FFT_Data_Graph_Buffer_Global,frequency))
