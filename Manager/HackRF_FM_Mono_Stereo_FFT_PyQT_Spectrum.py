...
def FM_demod(Data_buffer,RDS_Buffer,FM_Buff,sample_rate,Decimation):
...
if __name__ == '__main__':
    ...
    Fm=Process(target=FM_demod, args=(external_buff_Global,FM_RDS_Buff_Global,FM_Buff_Global,sample_rate,Fm_decimation))
